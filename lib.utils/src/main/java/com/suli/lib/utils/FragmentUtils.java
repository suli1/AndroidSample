...
public class FragmentUtils {
   ...
   */
  public static Fragment replaceFragment(FragmentManager fragmentManager, @IdRes int container,
   ...
   * @return 新显示的Fragment
   */
  public static Fragment switchFragment(FragmentManager fragmentManager, @IdRes int container,
      Fragment currentFragment, Class<? extends Fragment> newFragment, Bundle args,
